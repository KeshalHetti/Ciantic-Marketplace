            ...
            <div className="row">
              {/* <div className="col-xl-8 col-lg-7 col-md-6">
                <h5 className="text-light fw-normal title-dark">
                  Download the Ciantic app to explore any NFTs
                </h5>
              ...
              <div className="footer-py-60 footer-border">
                <div className="row">
                  <div className="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                    ...
                    <span className="text-gradient-primary">Ciantic Market!</span>{' '}The Best Place <br /> to{' '}
                    <span className="text-gradient-primary">Buy & Sell</span>{' '}
                    <br />Anything you want!
                  </h4>
                    <p className="para-desc mb-0 mt-4">
                      Buy, sell and discover exclusive assets around the world.
                    </p>
                  </div>
                  {/*end col*/}
              ...
              <div className="col-sm-6">
                <div className="text-sm-start">
                  <p className="mb-0">
                    ...
                    Designed & Developed By CianticLabs.
                  </p>
                </div>
              </div>
              {/*end col*/}
